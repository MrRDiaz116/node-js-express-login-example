...
module.exports ={ 
    ...
    if(serverSharedKey === peerSharedKey){
        console.log('El secreto compartido coincide entre cliente y contacto de confianza\n');
    }
...
encriptarDato: function(ZC1, ZC1Metodo, derivedKeyMetodo, ivMetodo, saltPrivada, ivUsuario, dato) {
    ...
    // Se desencripta el secreto compartido
    Z1_inverso = desencriptarSharedKey(ZC1, ZC1Metodo, derivedKeyMetodo, ivMetodo, saltPrivada, ivUsuario)
